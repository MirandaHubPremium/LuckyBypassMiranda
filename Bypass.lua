...
task.spawn(function()
    ...
    bgCircleStroke.Color = Color3.fromRGB(220, 20, 60) -- Carmesí
    ...
    progressCircle.BackgroundColor3 = Color3.fromRGB(220, 20, 60) -- Carmesí
...
-- Fondo de código tipo CMD en ROJO-CARMESÍ
...
-- Gradiente ROJO-CARMESÍ en el outline principal
local mainFrameStroke = Instance.new("UIStroke")
mainFrameStroke.Thickness = 10
mainFrameStroke.Color = Color3.fromRGB(220, 20, 60) -- Carmesí base
...
-- Título centrado horizontalmente con ROJO-CARMESÍ
local titleLabel = Instance.new("TextLabel")
...
-- Subtítulo "By Miranda" centrado debajo del título
local subtitleLabel = Instance.new("TextLabel")
...
-- Label de instrucción a la izquierda
...
inputStroke.Color = Color3.fromRGB(220, 20, 60) -- Carmesí
inputStroke.Parent = inputBox
createRedCrimsonGradientPulse(inputStroke)

-- Botón ENTER debajo del input con ROJO-CARMESÍ
...
serverStroke.Color = Color3.fromRGB(139, 0, 0) -- Rojo oscuro carmesí
...
-- Efectos de partículas en ROJO-CARMESÍ
